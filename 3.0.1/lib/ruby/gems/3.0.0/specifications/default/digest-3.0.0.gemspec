...
Gem::Specification.new do |s|
  ...
  s.files = ["digest.bundle".freeze, "digest.rb".freeze, "digest/bubblebabble.bundle".freeze, "digest/md5.bundle".freeze, "digest/rmd160.bundle".freeze, "digest/sha1.bundle".freeze, "digest/sha2.bundle".freeze, "digest/sha2.rb".freeze, "ext/digest/bubblebabble/extconf.rb".freeze, "ext/digest/extconf.rb".freeze, "ext/digest/md5/extconf.rb".freeze, "ext/digest/rmd160/extconf.rb".freeze, "ext/digest/sha1/extconf.rb".freeze, "ext/digest/sha2/extconf.rb".freeze]
